...
public class SliceOverlapDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(SliceOverlapDriver.class);
	...
	public static void main(String[] args) throws Exception {
		SliceOverlapDriver driver = new SliceOverlapDriver();
